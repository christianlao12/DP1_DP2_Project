...
sns.histplot(Isolated_wt_10,
             ...
             label='Isolated EPT80: Mean: {:.2f}, Std. Dev: {:.2f}, Median: {:.2f}'.format(np.nanmean(Isolated_wt_10),np.nanstd(Isolated_wt_10),np.nanmedian(Isolated_wt_10))
             )
...
sns.histplot(allonsets_wt_10,
             ...
             ax=axes,
             stat='percent',
             label='All EPT80: Mean: {:.2f}, Std. Dev: {:.2f}, Median: {:.2f}'.format(np.nanmean(allonsets_wt_10),np.nanstd(allonsets_wt_10),np.nanmedian(allonsets_wt_10))
             )
axes.xaxis.set_major_locator(ticker.MultipleLocator(1))
axes.set_ylim(0,14.5)
axes.legend(loc='center right')
